  ...
  return (
    <div>
      ...
      <GuideModal isOpen={isModalOpen}>
        ...
        <div>
          {/* {`${t('恭喜您！你打胜仗，获得了')} ${reward} NFT`} */}
          {`Congratulations!

          You have win the battle
          and obtained ( ${amount} )PsuB.

          It will be paid out
          after ( ${totalDelayDays} )day staking.`}
          ...
          <BasicButton onClick={toggleModal}>{t('再玩一次')}</BasicButton>
        </div>
      </GuideModal>
    </div>
  );
